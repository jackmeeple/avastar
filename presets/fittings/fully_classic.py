...
for obj in selection:
    ...
    obj.FittingValues.R_FOOT=0
    obj.FittingValues.R_LOWER_LEG=0
    obj.FittingValues.R_LOWER_ARM=0
    obj.FittingValues.PELVIS=0
    obj.FittingValues.R_CLAVICLE=0
    obj.FittingValues.L_UPPER_LEG=0
    obj.FittingValues.L_LOWER_ARM=0
    obj.FittingValues.L_UPPER_ARM=0
    obj.FittingValues.NECK=0
    obj.FittingValues.L_FOOT=0
    obj.FittingValues.L_LOWER_LEG=0
    obj.FittingValues.L_HAND=0
    obj.FittingValues.HEAD=0
    obj.FittingValues.R_UPPER_ARM=0
    obj.FittingValues.BELLY=0
    obj.FittingValues.R_HAND=0
    obj.FittingValues.R_UPPER_LEG=0
    obj.FittingValues.L_CLAVICLE=0
    obj.FittingValues.CHEST=0
